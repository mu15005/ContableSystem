        ...
        if (resultado.value) {
            ...
            $.post("CierreCorregido.php",{if:nombre,onModifiPeriodo:"true",idperiodo:idp},function(data){
               ...
               if(data==1){
                ...
                document.location.href="periodos.php";
                ...
                while ($fila = $result->fetch_object()) { ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                           ...
                                           <?php if($fila->subestado==1){ ?>
                                            
                                                 <button type="button" class="btn ripple-infinite btn-round btn-warning" style="width: 250px"  onclick="onGuardaCambios(<?php echo $fila->idperiodo ?>);">Guardar Cambios </button>
                                                
                                                    <?php   }else{ ?>
                                                  <button type="button" class="btn ripple-infinite btn-round btn-warning" <?php    if($num>0  || $fila->idperiodo==$max){echo("disabled='true'");} ?> style="width: 250px"  onclick="onModifica(<?php echo $fila->idperiodo ?>);">Consultar Copia de Seguridad</button>
                                              <?php     } ?>
